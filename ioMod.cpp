...
//new overloaded writeText() that will accept any/a different font color
...
void IoMod::writeText(const std::string& msg, int x, int y, SDL_Color color, TTF_Font& f) const {
  SDL_Surface* surface = TTF_RenderText_Solid(&f, msg.c_str(), color);
